...
const t = useTranslations("booking-success-view");
                  ...
                  <>
                    <div
                      ...
                      {giphyImage && !needsConfirmation && isReschedulable && (
                        ...
                        <img src={giphyImage} className="w-full rounded-lg" alt={t('giphy.alt-text')} />
                      )}
                      <div
                        className={classNames(
                            ...
                            {googleCalendarLink && (
                              <Link
                                ...
                                <svg
                                  ...
                                  viewBox="0 0 24 24">
                                  <title>{t('calendar-providers.google')}</title>
                            ...
                            {microsoftOutlookLink && (
                              <Link
                                ...
                                <svg
                                  ...
                                  xmlns="http://www.w3.org/2000/svg"
                                  viewBox="0 0 24 24">
                                  <title>{t('calendar-providers.microsoft-outlook')}</title>
                            ...
                            {microsoftOfficeLink && (
                              <Link
                                ...
                                <svg
                                  ...
                                  xmlns="http://www.w3.org/2000/svg"
                                  viewBox="0 0 24 24">
                                  <title>{t('calendar-providers.microsoft-office')}</title>
                  ...
                  (noShow ? (
                    ...
                    <>
                      ...
                      <TextArea
                        id="comment"
                        name="comment"
                        placeholder={t('feedback.placeholder-comment')}
                        rows={3}
                        disabled={isFeedbackSubmitted}
