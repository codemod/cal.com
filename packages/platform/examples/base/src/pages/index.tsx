  ...
  return (
    <main className={`flex min-h-screen flex-col ${inter.className} items-center justify-center`}>
      ...
      <div
        ...
        <div className="ml-32">
          <h1 className={`${poppins.className} w-[100%] pb-3 text-7xl font-bold`}>{t('hero.main-heading')}</h1>
          <p className={`w-[70%] font-normal ${inter.className} pb-3 text-2xl`}>{t('hero.getting-started-description')}</p>
