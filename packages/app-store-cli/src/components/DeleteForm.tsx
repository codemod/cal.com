...
const t = useTranslations("app-store-delete-form");
  ...
  if (state === "INITIALIZED") {
    return (
      <>
        <ImportantText>{t('instructions.confirm-deletion')}</ImportantText>
        <Text color="gray" italic>{t('descriptions.cleanup-warning')}</Text>
        <TextInput
